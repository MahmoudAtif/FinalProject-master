import 'package:blaghaty/Modules/adminpage/components/map.dart';
                    ...
                    Expanded(
                      child: buildButton(
                          ...
                          onPress: () {
                            ...
                            List d = reportModel.postion!.split(',');
                            double lat = double.parse(d[0].toString());
                            double long = double.parse(d[1].toString());
                            navigateTo(context, CustomAdminMap(lat: lat, long: long));
                          },
                          text: 'Accept',
                          type: 'Accept'),
                    ),
